# https://github.com/Thinklab-SJTU/awesome-ml4co/blob/master/src/generator.py

import csv
import os
import copy

abbr = {'Timestamp-included Tensor Decomposition': 'TiTD', 
        'Timestamp-based Transformation': 'TbT', 
        'Dynamic Embedding': 'DE',
        'Learning from Knowledge Graph Snapshots': 'LKGS', 
        'Reasoning with Historical Context': 'RHC',
        }
